...
Original file is located at
    https://colab.research.google.com/drive/1vS316HfFX3XswiG7n4eMmEVVn6TbQoWY
"""
...
"""El modelo se define como una subclase de Keras.model y tiene 3 capas
 
**tf.keras.layers.Embedding:** La capa de entradas se encargará de vectorizar los caracteres.

**tf.keras.layers.GRU:** Un tipo de RNN, es como la LSTM pero con una forget gate con un numero de neuronas igual a *rnn_units*

**tf.keras.layers.Dense:** La capa de salida con la misma cantidad de neuronas que los caracteres en nuestro vocabulario

"""
# Tamaño del vocabulario en el texto (N. de caracteres)
...
#"""Pasamos lo anterior a formato de texto"""
...
#"""Si el exponencial del error es aproximadamente igual al número de caracteres, vamos bien."""
...
tf.saved_model.save(
    model, './memoria', signatures=None, options=None
)
"""# Generando Texto"""
